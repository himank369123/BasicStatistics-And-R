...
knitr::include_graphics("D:/github/BasicStatistics-And-R/medi.png")
```
...
knitr::include_graphics("D:/github/BasicStatistics-And-R/mode.png")
```
***
...
knitr::include_graphics("D:/github/BasicStatistics-And-R/hist.png")
```
...
```{r  , echo=FALSE, Fig.cap="A caption", out.width = '50%'}
knitr::include_graphics("D:/github/BasicStatistics-And-R/stem.png")
```
...
```{r , echo=FALSE, Fig.cap="A caption", out.width = '50%'}
knitr::include_graphics("D:/github/BasicStatistics-And-R/box1.png")
```
...
```{r  , echo=FALSE, Fig.cap="A caption", out.width = '50%'}
knitr::include_graphics("D:/github/BasicStatistics-And-R/bell.png")
```
...
```{r  , echo=FALSE, Fig.cap="A caption", out.width = '50%'}
knitr::include_graphics("D:/github/BasicStatistics-And-R/uniform.png")
```
...
```{r , echo=FALSE, Fig.cap="A caption", out.width = '50%'}
knitr::include_graphics("D:/github/BasicStatistics-And-R/skew.png")
```
...
knitr::include_graphics("D:/github/BasicStatistics-And-R/bimodal.png")
```
...
```{r , echo=FALSE, Fig.cap="A caption", out.width = '50%'}
knitr::include_graphics("D:/github/BasicStatistics-And-R/sd.png")
```
...
```{r , echo=FALSE, Fig.cap="A caption", out.width = '50%'}
knitr::include_graphics("D:/github/BasicStatistics-And-R/emp.png")
```
...
```{r , echo=FALSE, Fig.cap="A caption", out.width = '50%'}
knitr::include_graphics("D:/github/BasicStatistics-And-R/cor.png")
```
...
```{r , echo=FALSE, Fig.cap="A caption", out.width = '50%'}
knitr::include_graphics("D:/github/BasicStatistics-And-R/scat.png")
```
...
```{r , echo=FALSE, Fig.cap="A caption", out.width = '50%'}
knitr::include_graphics("D:/github/BasicStatistics-And-R/contin.png")
```
...
```{r, echo=FALSE, Fig.cap="A caption", out.width = '50%'}
knitr::include_graphics("D:/github/BasicStatistics-And-R/log1.png")
```
